...
author: "Ethan Walker"
date: "Started 19 Nov 2019, Updated 19 Dec 2019"
output: pdf_document
---
...
pm_time_plot_function(id = "137", location = "NN")
head(gaps, 25)
head(pm_desc, 25)
tail(pm_desc, 25)
...
check_data <- kids_pm %>% 
  filter(area == "NN" & home_winter_id == "140") 
...
# write_rds(kids_pm_new2, "Output/kids_pm_new.rds")
```
