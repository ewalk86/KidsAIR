...
# Impute missing data; m = 5 datasets (check % missing data and match)
imputed_data <- mice(analysis_data, m=5)
...
model_ave <- mami(imputed_data, missing.data = "imputed", model = "gaussian",
                  ...
                  inference = "+boot", B = 15, X.org = analysis_data, print.time = TRUE)
