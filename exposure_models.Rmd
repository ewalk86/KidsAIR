...
analysis_data <- exposure_analysis_data_short %>% 
  ...
  select(pm_mean_sampling_period, area, income_3level, home_act_windows, 
                 ...
                 total_residents_2level, sums_events_sampling_period, mean_temp_sampling_period_5) %>% 
...
Looking at Lasso and Ridge regression
