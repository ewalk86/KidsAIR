...
write_rds(imputed_data, paste0(file_path, "Output/imputed_exposure_data_14may2020.rds"))

imputed_exposure_data <- read_rds(paste0(file_path, "Output/imputed_exposure_data_14may2020.rds"))
...
write_rds(model_ave, paste0(file_path, "Output/imputed_exposure_model_14may2020.rds"))

exposure_model <- read_rds(paste0(file_path, "Output/imputed_exposure_model_14may2020.rds"))
