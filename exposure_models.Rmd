...
hist(selected_vars$pm_mean_sampling_period)
...
missing_hist <- selected_vars %>% 
  mutate(missing_var = if_else(is.na(moisture_closest_2level), "missing yes", "missing no")) %>% 
  ggplot() +
...
imputed_data <- mice(selected_vars, m=5, maxit = 5,
