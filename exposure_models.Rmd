...
missing_summary <- selected_vars %>% 
  mutate(missing_var = if_else(is.na(stove_age_3level), "missing yes", "missing no")) %>%
...
imputed_data <- mice(selected_vars, m=10, maxit = 40,
                     method = c("polr", "logreg", "logreg", "logreg", "logreg",
                                "polr", "polr", "logreg", "logreg", "logreg",
                                "pmm", "pmm", "pmm", "polr", "pmm"))

write_rds(imputed_data, paste0(file_path, "Output/imputed_exposure_data_7may2020.rds"))
...
write_rds(model_ave, paste0(file_path, "Output/imputed_exposure_model_7may2020.rds"))

exposure_model <- read_rds(paste0(file_path, "Output/imputed_exposure_model_7may2020.rds"))

summary(test_model_results)
