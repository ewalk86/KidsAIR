...
author: "Ethan Walker"
date: "Started 19 Nov 2019, Updated 11 May 2020"
output: pdf_document
---
...
#write_rds(kids_linked_ids, paste0(file_path, "Output/kids_linked_ids.rds"))
```
...
kids_demographics <- read_rds(paste0(file_path, "Output/kids_combined_demographics.rds"))
```
...
# write_rds(demographics_clean, paste0(file_path, "Output/demographics_clean.rds"))
```
