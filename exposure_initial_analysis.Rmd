...
author: "Ethan Walker"
date: "Started 2 Feb 2020, Updated 19 March 2020"
output: pdf_document
---
  ...
  mutate(home_type_2level = fct_collapse(home_type,
         ...
         stove_age = factor(stove_age,
                         levels = c("0-5 years old", "6-10 years old",
                                    "11-15 years old", "16 + years old",
                                    "Do not know")),
         stove_age_4level = fct_collapse(stove_age,
                                  "0-5 years old" = "0-5 years old",
                                  "6-15 years old" = c("6-10 years old",
                                                       "11-15 years old"),
                                  "16 + years old" = "16 + years old",
...
#write_rds(analysis_data7, "Output/exposure_analysis_data.rds")
#write_csv(analysis_data7, "Output/exposure_analysis_data.csv")
```
