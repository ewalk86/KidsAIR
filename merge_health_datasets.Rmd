...
author: "Ethan Walker"
date: "Started 27 March 2020, Updated 8 April 2020"
output: pdf_document
---
...
#write_rds(health_merged6, "Output/health_data_merged.rds")
#write_csv(health_merged6, "Output/health_data_merged.csv")
```
