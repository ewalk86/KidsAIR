...
author: "Ethan Walker"
date: "Started 27 March 2020, Updated 14 May 2020"
output: pdf_document
---
...
write_rds(health_merged5, paste0(output_path, "Output/health_data_merged.rds"))
write_csv(health_merged5, paste0(output_path, "Output/health_data_merged.csv"))
```
...
health_exposure_data_sampling_day <- health_data_merged %>% 
  ...
  mutate(winter_id = as.character(winter_id)) %>% 
  right_join(exposure_analysis_data_medium,
