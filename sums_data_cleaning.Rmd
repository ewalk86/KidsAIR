...
author: "Ethan Walker"
date: "Started 23 Dec 2019, Updated 22 June 2020"
output: pdf_document
---
...
wmt_sums_data_log <- read_csv(paste0(file_path, "Input/WMT/ibutton.csv"), 
                              na = c("NULL", "")) %>%
...
wmt_sums_log <- wmt_sums_data_log %>% 
  right_join(kids_linked_ids, by = "home_winter_id") %>% 
  select(home_winter_id, winter_id, home, home_id, date_log, time_log, ibid) %>% 
  arrange(home, date_log) %>% 
  mutate(date_log = ymd(date_log))
  
write_rds(wmt_sums_log, paste0(file_path, "Output/wmt_sums_data_log.rds"))
#write_csv(wmt_sums_log, paste0(file_path, "Output/wmt_sums_data_log.csv"))


# Input file from Box: ibuttonupd.xlsx
wmt_sums_data_log_updated <- read_csv(paste0(file_path, "Input/WMT/ibuttonupd.csv"), 
                                      na = c("NULL", "")) %>% 
  mutate(home_winter_id = as.character(HomeWinterID),
         date = ChangeDate,
         time = ChangeTime,
...
wmt_sums_log <- wmt_sums_data_log_updated %>% 
  right_join(kids_linked_ids, by = "home_winter_id") %>% 
  select(home_winter_id, home, home_id, date, time, alarms, file_name) %>% 
  arrange(home, date)

# write_csv(wmt_sums_log, paste0(file_path, "Output/wmt_sums_data_log_updated.csv"))
```
...
```{r}
# Input file from Box: ibutton.xlsx
nn_sums_data_log <- read_csv(paste0(file_path, "Input/NN/ibutton.csv"), 
                              na = c("NULL", "")) %>%
  mutate(home_winter_id = as.character(HomeWinterID),
         ibid = iButtonID,
         date_log = InstallDate,
...
#write_csv(nn_sums_log, paste0(file_path, "Output/nn_sums_data_log.csv"))


# Input file from Box: ibuttonupd.xlsx
nn_sums_data_log_updated <- read_csv(paste0(file_path, "Input/NN/ibuttonupd.csv"), 
                                      na = c("NULL", "")) %>% 
  mutate(home_winter_id = as.character(HomeWinterID),
         date = ChangeDate,
         time = ChangeTime,
...
# write_csv(nn_sums_log, paste0(file_path, "Output/nn_sums_data_log_updated.csv"))
```
...
```{r}
# Input file from Box: ibutton.xlsx
ak_sums_data_log <- read_csv(paste0(file_path, "Input/AK/ibutton.csv"), 
                              na = c("NULL", "")) %>%
  mutate(home_winter_id = as.character(HomeWinterID),
         ibid = iButtonID,
         date_log = InstallDate,
...
write_rds(ak_sums_log, paste0(file_path, "Output/ak_sums_data_log.rds"))
#write_csv(ak_sums_log, paste0(file_path, "Output/ak_sums_data_log.csv"))


# Input file from Box: ibuttonupd.xlsx
ak_sums_data_log_updated <- read_csv(paste0(file_path, "Input/AK/ibuttonupd.csv"), 
                                      na = c("NULL", "")) %>% 
  mutate(home_winter_id = as.character(HomeWinterID),
         date = ChangeDate,
         time = ChangeTime,
...
list_csv_files <- list.files(paste0(file_path, "Input/WMT/sums_csv_new"))

# Set working directory and load files in list; extract file name and add as column
## run next 13 lines together
setwd(paste0(file_path, "Input/WMT/sums_csv_new")) # set new working directory
...
list_csv_files_2 <- list.files(paste0(file_path, "Input/WMT/sums_csv_old/format_1"))

# Set working directory and load files in list; extract file name and add as column
## run next 9 lines together
setwd(paste0(file_path, "Input/WMT/sums_csv_old/format_1"))
...
list_csv_files_3 <- list.files(paste0(file_path, "Input/WMT/sums_csv_old/format_2"))

# Set working directory and load files in list; extract file name and add as column
## run next 12 lines together
setwd(paste0(file_path, "Input/WMT/sums_csv_old/format_2"))
...
list_xlsx_files <- list.files(paste0(file_path, "Input/WMT/sums_xlsx_files/header_skip16"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/WMT/sums_xlsx_files/header_skip16"))
...
## 2 columns: datetime, temp (C)
list_xlsx_files <- list.files(paste0(file_path, "Input/WMT/sums_xlsx_files/header_skip21"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/WMT/sums_xlsx_files/header_skip21"))
initial_data = tibble(file_list = list_xlsx_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
...
## 2 columns: datetime, temp (C)
list_xlsx_files <- list.files(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_2col_c"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_2col_c"))
initial_data = tibble(file_list = list_xlsx_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
...
list_xlsx_files <- list.files(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_4col_c"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_4col_c"))
initial_data = tibble(file_list = list_xlsx_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_xlsx)) %>%
  unnest(save_data) %>%
...
list_xlsx_files <- list.files(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_4col_f"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/WMT/sums_xlsx_files/no_header_4col_f"))
initial_data = tibble(file_list = list_xlsx_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_xlsx)) %>%
  unnest(save_data) %>%
...
# write_rds(wmt_sums_raw, paste0(file_path, "Output/wmt_sums_raw.rds"))
```
...
## from the original file type of the field instrument.
## The files have 5 columns: line, date, time, temp (C), notes
list_csv_files <- list.files(paste0(file_path, "Input/NN/sums_csv_new"))

# Set working directory and load files in list; extract file name and add as column
## run next 12 lines together
setwd(paste0(file_path, "Input/NN/sums_csv_new"))
...
list_csv_files_2 <- list.files(paste0(file_path, "Input/NN/sums_csv_old/2col-c"))

# Set working directory and load files in list; extract file name and add as column
## run next 7 lines together
setwd(paste0(file_path, "Input/NN/sums_csv_old/2col-c"))
initial_data = tibble(file_list = list_csv_files_2) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_csv)) %>%
  unnest(save_data) %>%
...
list_csv_files_3 <- list.files(paste0(file_path, "Input/NN/sums_csv_old/3col-f"))

# Set working directory and load files in list; extract file name and add as column
## run next 12 lines together
setwd(paste0(file_path, "Input/NN/sums_csv_old/3col-f"))
initial_data = tibble(file_list = list_csv_files_3) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_csv, skip = 1,
...
# write_rds(nn_sums_raw, paste0(file_path, "Output/nn_sums_raw.rds"))
```
...
## from the original file type of the field instrument.
## The files have 5 columns: line, date, time, temp (C), notes
list_csv_files <- list.files(paste0(file_path, "Input/AK/sums_csv_new"))

# Set working directory and load files in list; extract file name and add as column
## run next 12 lines together
setwd(paste0(file_path, "Input/AK/sums_csv_new"))
initial_data = tibble(file_list = list_csv_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_csv,
                            col_names = c("line", "date", "time", "temp_c", "trash"),
...
##### NO LONGER USING THESE FILES!
##### COMPARED TO CORRESPONDING LOGTAG FILES, THE TIMESTAMPS ARE OFF
list_csv_files_2 <- list.files(paste0(file_path, "Input/AK/sums_csv_old"))

# Set working directory and load files in list; extract file name and add as column
## run next 7 lines together
setwd(paste0(file_path, "Input/AK/sums_csv_old"))
initial_data = tibble(file_list = list_csv_files_2) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_csv, skip = 1,
                            col_names = c("line", "date", "time", "temp_f", "trash"),
...
list_xlsx_files <- list.files(paste0(file_path, "Input/AK/sums_xlsx_temp_c"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/AK/sums_xlsx_temp_c"))
initial_data = tibble(file_list = list_xlsx_files) %>%
  extract(file_list, "home", remove = FALSE) %>%
  mutate(save_data = lapply(file_list, read_xlsx,
...
list_xlsx_files2 <- list.files(paste0(file_path, "Input/AK/sums_xlsx_temp_f"))

# Set working directory and load files in list; extract file name and add as column
## run next 6 lines together
setwd(paste0(file_path, "Input/AK/sums_xlsx_temp_f"))
...
# write_rds(paste0(file_path, ak_sums_raw, "Output/ak_sums_raw.rds"))
```
...
wmt_sums_raw <- read_rds(paste0(file_path, "Output/wmt_sums_raw.rds")) 

nn_sums_raw <- read_rds(paste0(file_path, "Output/nn_sums_raw.rds"))

ak_sums_raw <- read_rds(paste0(file_path, "Output/ak_sums_raw.rds"))
...
# Load SUMs data logs
wmt_sums_log <- read_rds(paste0(file_path, "Output/wmt_sums_data_log.rds"))
nn_sums_log <- read_rds(paste0(file_path, "Output/nn_sums_data_log.rds"))
ak_sums_log <- read_rds(paste0(file_path, "Output/ak_sums_data_log.rds"))
...
write_csv(sums_time_comparison, paste0(file_path, "Output/sums_time_comparison.csv"))
write_rds(sums_time_comparison, paste0(file_path, "Output/sums_time_comparison.rds"))
```
...
wmt_sums_stop <- read_csv(paste0(file_path, "Input/WMT/medicalvisit.csv")) %>% 
  mutate(home_winter_id = as.character(HomeWinterID),
         final_visit_date = as.character(VisitDate),
         final_visit_date = if_else(final_visit_date == "2025-11-04", "2015-11-04", final_visit_date),
         final_visit_date = ymd(final_visit_date)) %>% 
...
wmt_sums_start <- read_rds(paste0(file_path, "Output/wmt_sums_data_log.rds")) %>% 
  mutate(area = "WMT",
         time_log = as.character(time_log),
         time_log = if_else(is.na(time_log), "00:00:00", time_log)) %>% 
  unite("datetime_start", c("date_log", "time_log"), sep = " ") %>% 
...
wmt_sums_raw <- all_sums_raw %>% 
  filter(area == "WMT") %>% 
  right_join(wmt_sums_start_stop, by = c("area", "home")) %>% 
  mutate(filter_var = 
...
# write_rds(wmt_sums_filtered, paste0(file_path, "Output/wmt_sums_filtered.rds"))

  
#####

nn_sums_stop <- read_xlsx(paste0(file_path, "Input/NN/nn_medicalvisit_20200108.xlsx")) %>% 
...
nn_sums_start <- read_xlsx(paste0(file_path, "Input/NN/nn_sums_start_times_20200108.xlsx")) %>% 
  mutate(datetime_start = ymd_hms(datetime_start))
...
# write_rds(nn_sums_filtered, paste0(file_path, "Output/nn_sums_filtered.rds"))


#####

ak_sums_stop <- read_xlsx(paste0(file_path, "Input/AK/ak_medicalvisit_20200108.xlsx")) %>% 
  mutate(home_winter_id = HomeWinterID,
         final_visit_date = ymd(VisitDate)) %>% 
  group_by(home_winter_id) %>% 
  arrange(final_visit_date) %>% 
...
ak_sums_start <- read_xlsx(paste0(file_path, "Input/AK/ak_sums_start_times_20200108.xlsx")) %>% 
  mutate(datetime_start = ymd_hms(datetime_start))
...
# write_rds(ak_sums_filtered, paste0(file_path, "Output/ak_sums_filtered.rds"))
```
...
wmt_sums_filtered <- read_rds(paste0(file_path, "Output/wmt_sums_filtered.rds"))
nn_sums_filtered <- read_rds(paste0(file_path, "Output/nn_sums_filtered.rds"))
ak_sums_filtered <- read_rds(paste0(file_path, "Output/ak_sums_filtered.rds"))

check_dates <- ak_sums_filtered %>% 
  group_by(home) %>% 
...
write_rds(all_sums_filtered, paste0(file_path, "Output/all_sums_filtered.rds"))
```

# Continue cleaning up SUMs data
```{r}
file_path <- c("C:/Users/ethan.walker/Box/Ethan Walker UM/R/KidsAIR/")
all_sums_filtered <- read_rds(paste0(file_path, "Output/all_sums_filtered.rds"))
kids_linked_ids <- read_rds(paste0(file_path, "Output/kids_linked_ids_final.rds")) %>% 
  select(home_winter_id, area, treatment_assigned, treatment_actual)
...
write_rds(sums_clean, paste0(file_path, "Output/sums_clean.rds"))


########## New cleaning on 6 Feb 2020 ##########

sums_clean <- read_rds(paste0(file_path, "Output/sums_clean.rds"))
...
write_rds(sums_new, paste0(file_path, "Output/sums_clean.rds"))
```
...
sums_events_27 <- sums_clean %>% 
  mutate(datetime_sums = ymd_hms(datetime_sums)) %>% 
  group_by(area, home, winter_id) %>%
  mutate(threshold_temp = if_else(temp_c_sums >= 27, 1, 0),
         threshold_temp_event = if_else(threshold_temp == 1 & lag(threshold_temp) == 0, 
                                        "start", "Temp < threshold"),
         threshold_temp_event = if_else(is.na(threshold_temp_event), "start", threshold_temp_event),
         threshold_temp_event = if_else(threshold_temp == 1 & threshold_temp_event == "Temp < threshold",
...
#write_rds(sums_events_25, "Output/sums_events_25.rds")
#write_rds(sums_events_27, "Output/sums_events_27.rds")
#write_rds(sums_events_30, "Output/sums_events_30.rds")
```
