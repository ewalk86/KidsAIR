...
```{r}
stove_grade_plot <- stove_grades_clean %>% 
  filter(winter_id == 1) %>% 
...
stove_use_plot_function(stove_use_data, "burn_level")
stove_use_plot_function(stove_use_data, "wood_type")
stove_use_plot_function(stove_use_data, "wood_collect")
stove_use_plot_function(stove_use_data, "wood_collect_method")
stove_use_plot_function(stove_use_data, "wood_cords")
```
