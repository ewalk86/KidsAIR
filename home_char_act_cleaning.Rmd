...
author: "Ethan Walker"
date: "Started 13 Jan 2020, Updated 4 March 2020"
output: pdf_document
---
...
# write_rds(home_char_clean, "Output/home_char_clean.rds")
```
...
##### WMT #####
# Load data
home_act_initial_wmt <- read_csv(paste0(file_path, "Input/WMT/wmt_home_activity_20200113.csv"))
...
##### NN #####
# Load data
home_act_initial_nn <- read_xlsx(paste0(file_path, "Input/NN/nn_home_activity_20200113.xlsx"))
...
##### AK #####
# Load data
home_act_initial_ak <- read_xlsx(paste0(file_path, "Input/AK/ak_home_activity_20200113.xlsx"))
